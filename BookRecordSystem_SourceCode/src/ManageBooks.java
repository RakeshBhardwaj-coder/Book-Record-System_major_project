...
public class ManageBooks extends javax.swing.JFrame {
    ...
    public void clear() {
        ...
        this.bName.setText(null);
        this.bAuthor.setText(null);
        this.bEdition.setText(null);
        this.bForYear.setSelectedItem(null);
        this.bCount.setText(null);
    }
    ...
    private void initComponents() {
        ...
        bForYear = new javax.swing.JComboBox<>();
        ...
        movePanelLayout.setHorizontalGroup(
            ...
            .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1150, Short.MAX_VALUE)
        );
        ...
        JTextField12.setText("Book Name");

        bName.setBackground(new java.awt.Color(254, 254, 254));
        bName.setForeground(new java.awt.Color(1, 1, 1));

        bName1.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName1.setForeground(new java.awt.Color(1, 1, 1));
        bName1.setText("Book Author");

        bAuthor.setBackground(new java.awt.Color(254, 254, 254));
        bAuthor.setForeground(new java.awt.Color(1, 1, 1));

        bName2.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName2.setForeground(new java.awt.Color(1, 1, 1));
        bName2.setText("Book Edition");

        bEdition.setBackground(new java.awt.Color(254, 254, 254));
        bEdition.setForeground(new java.awt.Color(1, 1, 1));

        bName3.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName3.setForeground(new java.awt.Color(1, 1, 1));
        bName3.setText("Book for Year");

        bName4.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName4.setForeground(new java.awt.Color(1, 1, 1));
        bName4.setText("Book Count");

        bCount.setBackground(new java.awt.Color(254, 254, 254));
        bCount.setForeground(new java.awt.Color(1, 1, 1));
        ...
        bForYear.setBackground(new java.awt.Color(254, 254, 254));
        bForYear.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bForYear.setForeground(new java.awt.Color(1, 1, 1));
        bForYear.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4" }));
        bForYear.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                bForYearActionPerformed(evt);
            }
        });
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(bCount, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(bName3, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(bForYear, 0, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(bName2, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addGap(18, 18, 18)
                                .addComponent(bEdition, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    .addComponent(bName1, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(bAuthor, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addGroup(jPanel5Layout.createSequentialGroup()
                                    .addComponent(JTextField12, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addGap(18, 18, 18)
                                    .addComponent(bName, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(bEdition, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(bName3, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bForYear, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName4, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(bCount, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AddBtn)
    ...
    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed
        ...
        int bEdition, bForYear, bCount;
        bName = this.bName.getText();
        bAuthor = this.bAuthor.getText();
        bEdition = Integer.parseInt(this.bEdition.getText());
        bCount = Integer.parseInt(this.bCount.getText());
        bForYear = Integer.parseInt(this.bForYear.getSelectedItem().toString());
        ...
        try {
            ...
            qry = "INSERT INTO db_Book(b_name,b_author,b_edition,b_count,b_for_year) VALUES ('" + bName + "','" + bAuthor + "', " + bEdition + "  , " + bCount + ", " + bForYear + ")";
            stmt = con.createStatement();
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_Book_Record_System", "root", "");
            stmt = con.createStatement();
            qry = "UPDATE db_Book SET b_name='" + bName + "', b_author='" + bAuthor + "', b_edition=" + bEdition + " , b_for_year= " + bForYear + ", b_count=" + bCount + " WHERE b_id=" + Integer.parseInt(this.bId.getText());
            int row = stmt.executeUpdate(qry);
            if (row > 0) {
    ...
    private void bForYearActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_bForYearActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_bForYearActionPerformed
    ...
    private void deleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteActionPerformed
        ...
        try {
            ...
            if (delete == 0) {
                // 0:yes 1:No 2:cancel
                qry = "Delete From db_Book where b_id=" + Integer.parseInt(this.bId.getText());
                int row = stmt.executeUpdate(qry);
                if (row > 0) {
                    clear();
                    LoadBookData();
    ...
    private void bookRecordsTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bookRecordsTableMouseClicked
        ...
        bId.setText(tm.getValueAt(row, 1).toString());
        bName.setText((String) tm.getValueAt(row, 2));
        bAuthor.setText(tm.getValueAt(row, 3).toString());
    ...
    private javax.swing.JComboBox<String> bForYear;
