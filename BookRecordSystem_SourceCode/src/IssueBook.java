...
//        addBookPanel.setVisible(false);
    ...
    public void setAllColors() {
        ...
        bookIssuedTable.setSelectionBackground(tableSelectionColor);
...
//            ps.setString(1, name);
            ...
            dtm = (DefaultTableModel) bookIssuedTable.getModel();
            dtm.setRowCount(0);

            while (res.next()) {

                records[0] = sno;
                records[1] = res.getInt("issu_id");
...
//            this.bookAvail.setText("Book Availiblity : "+bookAvailiblity);
    ...
    private void initComponents() {
        ...
        issuId = new javax.swing.JTextField();
        ...
        bookIssuedTable = new javax.swing.JTable();
        ...
        lblYear.setForeground(new java.awt.Color(1, 1, 1));
        lblYear.setText("Year");

        lblRollno.setFont(new java.awt.Font("Ubuntu", 0, 18)); // NOI18N
        lblRollno.setForeground(new java.awt.Color(1, 1, 1));
        lblRollno.setText("Rollno");

        lblBranch.setFont(new java.awt.Font("Ubuntu", 0, 18)); // NOI18N
        lblBranch.setForeground(new java.awt.Color(1, 1, 1));
                    ...
                    .addGroup(jPanel3Layout.createSequentialGroup()
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel3Layout.createSequentialGroup()
                                ...
                                .addComponent(returnTabBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 125, javax.swing.GroupLayout.PREFERRED_SIZE)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(reissueBtn, javax.swing.GroupLayout.PREFERRED_SIZE, 111, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel3Layout.setVerticalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(29, 29, 29)
                .addComponent(lblRollno, javax.swing.GroupLayout.PREFERRED_SIZE, 37, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(31, 31, 31)
                .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(lblBranch, javax.swing.GroupLayout.PREFERRED_SIZE, 36, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(jPanel3, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 50, 450, 260));
        ...
        issuBook.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                issuBookCaretUpdate(evt);
            }
        });
        ...
        issuId.setBackground(new java.awt.Color(254, 254, 254));
        issuId.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                issuIdActionPerformed(evt);
            }
        });
            ...
            .addGroup(addBookTabLayout.createSequentialGroup()
                .addGroup(addBookTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(addBookTabLayout.createSequentialGroup()
                        .addGap(21, 21, 21)
                        .addGroup(addBookTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(issuId, javax.swing.GroupLayout.PREFERRED_SIZE, 158, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        addBookTabLayout.setVerticalGroup(
            ...
            .addGroup(addBookTabLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(issuId, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        addBtn2.setBackground(new java.awt.Color(254, 254, 254));
        addBtn2.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        addBtn2.setForeground(new java.awt.Color(1, 1, 1));
        addBtn2.setText("Reissue");
        ...
        reissueTabLayout.setHorizontalGroup(
            ...
            .addGroup(reissueTabLayout.createSequentialGroup()
                .addGroup(reissueTabLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(reissueTabLayout.createSequentialGroup()
                        .addGap(137, 137, 137)
                        .addComponent(addBtn2, javax.swing.GroupLayout.PREFERRED_SIZE, 74, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel1.add(tabpane, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 270, 450, 540));
        tabpane.getAccessibleContext().setAccessibleName("tab");
        ...
        bookIssuedTable.setBackground(new java.awt.Color(254, 254, 254));
        bookIssuedTable.setFont(new java.awt.Font("Ubuntu", 0, 18)); // NOI18N
        bookIssuedTable.setForeground(new java.awt.Color(1, 1, 1));
        bookIssuedTable.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {
        ...
        bookIssuedTable.setRowHeight(25);
        bookIssuedTable.setRowMargin(10);
        bookIssuedTable.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                bookIssuedTableMouseClicked(evt);
            }
        });
        jScrollPane1.setViewportView(bookIssuedTable);
...
//        issuName = getIssuName.getText();
        ...
        try {
            ...
            qry = "INSERT INTO db_Book_Issued(issu_name,issu_book,issu_book_author,issu_book_code,issu_date,issu_reissue_date,issu_return_date) VALUES('" + issuName + "' ,'" + issuBook + "','" + issuBookAuthor + "'," + issuBookCode + " , '" + issueDate + "', '" + reissueDate + "', '" + returnDate + "') ";
            stmt = con.createStatement();
            int row = stmt.executeUpdate(qry);
            if (row > 0 && bookAvailable > 0) {
                JOptionPane.showMessageDialog(this, "Name " + issuName + " book Added");
                bookAvailable -= 1;
...
//                JOptionPane.showMessageDialog(this, "count Update Succssesfully");
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_Book_Record_System", "root", "");
            stmt = con.createStatement();
            qry = "UPDATE db_Book_Issued SET issu_book = '" + issuBook + "', issu_book_author='" + issuBookAuthor + "',issu_book_code=" + issuBookCode + " ,issu_date='" + issueDate + "' WHERE issu_id = " + issuId.getText();
    ...
    private void issuIdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_issuIdActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_issuIdActionPerformed
    ...
    private void returnBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_returnBtnActionPerformed
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_Book_Record_System", "root", "");
            stmt = con.createStatement();
            qry = "UPDATE db_Book_Issued SET issu_return_date='" + returnDate + "' WHERE issu_id = " + issuId.getText();
...
//                JOptionPane.showMessageDialog(this, "count Update Succssesfully");
    ...
    private void addBtn2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addBtn2ActionPerformed
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_Book_Record_System", "root", "");
            stmt = con.createStatement();
            qry = "UPDATE db_Book_Issued SET issu_reissue_date='" + reissueDate + "' WHERE issu_id = " + issuId.getText();
    ...
    private void bookIssuedTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_bookIssuedTableMouseClicked
        // TODO add your handling code here:
        int row = bookIssuedTable.getSelectedRow();
        TableModel tm = bookIssuedTable.getModel();
        ...
        issuId.setText(tm.getValueAt(row, 1).toString());
...
//                    bookAvailable = Integer.parseInt(bookAvail.getText());
    ...
    }//GEN-LAST:event_bookIssuedTableMouseClicked
...
//        this.bookId.setText((String)tm.getValueAt(row, 1));
//        issuBookCode.setText(tm.getValueAt(row, 4).toString());
//        bEdition.setText(tm.getValueAt(row, 4).toString());
//        bForYear.setSelectedItem(tm.getValueAt(row, 5).toString());
//        bCount.setText(tm.getValueAt(row, 6).toString());
    }//GEN-LAST:event_bookRecordsTableMouseClicked

    private void issuBookCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_issuBookCaretUpdate
        //        // TODO add your handling code here:

    }//GEN-LAST:event_issuBookCaretUpdate
    ...
    private javax.swing.JTable bookIssuedTable;
    ...
    public javax.swing.JTextField getIssuName;
    ...
    public javax.swing.JTextField issuId;
    ...
    public javax.swing.JLabel lblBranch;
    public javax.swing.JLabel lblName;
    public javax.swing.JLabel lblRollno;
