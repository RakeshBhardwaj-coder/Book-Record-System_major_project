...
//        TableModel tm = StudentRecordsTable.getModel();
     ...
     */
    public void clear() {
        stu_txt_search.setText(null);
        stuName.setText(null);
        stuEmail.setText(null);
        stuMobile.setText(null);
        stuRollno.setText(null);
        stuBranch.setText(null);
        stuYear.setSelectedItem(null);
        stuDetail.setText(null);
        stuAddress.setText(null);
        stuSeason.setText(null);
        stuBtnGroup.clearSelection();
    }
    ...
    private void initComponents() {
        ...
        stuBtnGroup = new javax.swing.ButtonGroup();
        ...
        stu_txt_search = new javax.swing.JTextField();
        ...
        stuMobile = new javax.swing.JTextField();
        ...
        stuSeason = new javax.swing.JTextField();
        stuDetail = new javax.swing.JTextField();
        bName6 = new javax.swing.JLabel();
        stuMale = new javax.swing.JCheckBox();
        stuFemale = new javax.swing.JCheckBox();
        stuOther = new javax.swing.JCheckBox();
        bName7 = new javax.swing.JLabel();
        stuRollno = new javax.swing.JTextField();
        bName8 = new javax.swing.JLabel();
        stuBranch = new javax.swing.JTextField();
        bName9 = new javax.swing.JLabel();
        ...
        minimizeLayout.setHorizontalGroup(
            ...
            .addComponent(minBtn, javax.swing.GroupLayout.DEFAULT_SIZE, 40, Short.MAX_VALUE)
        );
        ...
        movePanelLayout.setHorizontalGroup(
            ...
            .addComponent(jLabel5, javax.swing.GroupLayout.Alignment.TRAILING, javax.swing.GroupLayout.DEFAULT_SIZE, 1223, Short.MAX_VALUE)
        );
        ...
        stu_txt_search.setBackground(new java.awt.Color(254, 254, 254));
        stu_txt_search.setForeground(new java.awt.Color(1, 1, 1));
        stu_txt_search.addCaretListener(new javax.swing.event.CaretListener() {
            public void caretUpdate(javax.swing.event.CaretEvent evt) {
                stu_txt_searchCaretUpdate(evt);
            }
        });
        stu_txt_search.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                stu_txt_searchActionPerformed(evt);
            }
        });
        ...
        jPanel3Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel3Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addComponent(stu_txt_search, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        JTextField12.setText("Student  Name");

        stuName.setBackground(new java.awt.Color(254, 254, 254));
        stuName.setForeground(new java.awt.Color(1, 1, 1));

        bName1.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName1.setForeground(new java.awt.Color(1, 1, 1));
        bName1.setText("Email");

        stuEmail.setBackground(new java.awt.Color(254, 254, 254));
        stuEmail.setForeground(new java.awt.Color(1, 1, 1));

        bName2.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName2.setForeground(new java.awt.Color(1, 1, 1));
        bName2.setText("Mobile");

        stuMobile.setBackground(new java.awt.Color(254, 254, 254));
        stuMobile.setForeground(new java.awt.Color(1, 1, 1));

        bName3.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName3.setForeground(new java.awt.Color(1, 1, 1));
        bName3.setText("Detail");

        bName4.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName4.setForeground(new java.awt.Color(1, 1, 1));
        bName4.setText("Address");

        stuAddress.setBackground(new java.awt.Color(254, 254, 254));
        stuAddress.setForeground(new java.awt.Color(1, 1, 1));
        ...
        deleteBtn.setBackground(new java.awt.Color(254, 254, 254));
        deleteBtn.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        deleteBtn.setForeground(new java.awt.Color(1, 1, 1));
        ...
        stuSeason.setBackground(new java.awt.Color(254, 254, 254));
        stuSeason.setForeground(new java.awt.Color(1, 1, 1));

        stuDetail.setBackground(new java.awt.Color(254, 254, 254));
        stuDetail.setForeground(new java.awt.Color(1, 1, 1));

        bName6.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName6.setForeground(new java.awt.Color(1, 1, 1));
        bName6.setText("Gender");

        stuMale.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        stuMale.setForeground(new java.awt.Color(1, 1, 1));
        stuMale.setText("Male");

        stuFemale.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        stuFemale.setForeground(new java.awt.Color(1, 1, 1));
        stuFemale.setText("Female");

        stuOther.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        stuOther.setForeground(new java.awt.Color(1, 1, 1));
        stuOther.setText("Other");

        bName7.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName7.setForeground(new java.awt.Color(1, 1, 1));
        bName7.setText("Roll no");

        stuRollno.setBackground(new java.awt.Color(254, 254, 254));
        stuRollno.setForeground(new java.awt.Color(1, 1, 1));

        bName8.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName8.setForeground(new java.awt.Color(1, 1, 1));
        bName8.setText("Branch");

        stuBranch.setBackground(new java.awt.Color(254, 254, 254));
        stuBranch.setForeground(new java.awt.Color(1, 1, 1));

        bName9.setFont(new java.awt.Font("Ubuntu", 0, 14)); // NOI18N
        bName9.setForeground(new java.awt.Color(1, 1, 1));
        bName9.setText("Year");

        stuYear.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "1", "2", "3", "4" }));
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            ...
                            .addGap(18, 18, 18)
                            .addComponent(stuAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(bName3, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(stuDetail, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(bName2, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(stuMobile, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGroup(jPanel5Layout.createSequentialGroup()
                            .addComponent(bName1, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGap(18, 18, 18)
                            .addComponent(stuEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                        ...
                        .addGap(18, 18, 18)
                        .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addComponent(stuName, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addGroup(jPanel5Layout.createSequentialGroup()
                                .addComponent(stuMale)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                                .addComponent(stuFemale)
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                                .addComponent(stuOther))))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(bName7, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(stuRollno, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(bName8, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                        .addComponent(stuBranch, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        .addComponent(bName9, javax.swing.GroupLayout.PREFERRED_SIZE, 137, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(18, 18, 18)
                    ...
                    .addGroup(jPanel5Layout.createSequentialGroup()
                        ...
                        .addGap(18, 18, 18)
                        .addComponent(stuSeason, javax.swing.GroupLayout.PREFERRED_SIZE, 215, javax.swing.GroupLayout.PREFERRED_SIZE)))
        ...
        jPanel5Layout.setVerticalGroup(
            ...
            .addGroup(jPanel5Layout.createSequentialGroup()
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(stuName, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                ...
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    ...
                    .addComponent(stuEmail, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName2, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuMobile, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName7, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuRollno, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 18, Short.MAX_VALUE)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName8, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuBranch, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(bName9, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuYear, javax.swing.GroupLayout.PREFERRED_SIZE, 32, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName3, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuDetail, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(14, 14, 14)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName4, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuAddress, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(bName5, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(stuSeason, javax.swing.GroupLayout.PREFERRED_SIZE, 26, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(18, 18, 18)
                .addGroup(jPanel5Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(AddBtn)
        ...
        AllIcons.setBackground(new java.awt.Color(53, 52, 53));
    ...
    private void stu_txt_searchCaretUpdate(javax.swing.event.CaretEvent evt) {//GEN-FIRST:event_stu_txt_searchCaretUpdate
        // TODO add your handling code here:
        Connection con;
        Statement stmt;
        ResultSet res;
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_Book_Record_System", "root", "");
            stmt = con.createStatement();
            qry = "Select * from db_Student where stu_name like '%" + stu_txt_search.getText() + "%'";
            res = stmt.executeQuery(qry);

            Object[] stuRecords = new Object[11];
            ...
            while (res.next()) {
                stuRecords[0] = sno;
                stuRecords[1] = res.getString("stu_name");
                stuRecords[2] = res.getString("stu_gender");
                stuRecords[3] = res.getString("stu_email");
                stuRecords[4] = res.getLong("stu_mobile");
                stuRecords[5] = res.getLong("stu_rollno");
                stuRecords[6] = res.getString("stu_branch");
                stuRecords[7] = res.getLong("stu_year");
                stuRecords[8] = res.getString("stu_detail");
                stuRecords[9] = res.getString("stu_address");
                stuRecords[10] = res.getString("stu_season");
                dtm.addRow(stuRecords);
                sno++;
    ...
    }//GEN-LAST:event_stu_txt_searchCaretUpdate

    private void stu_txt_searchActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_stu_txt_searchActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_stu_txt_searchActionPerformed

    private void AddBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AddBtnActionPerformed
        // TODO add your handling code here:
        String stuName, stuGender = "", stuEmail, stuBranch, stuDetail, stuAddress, stuSeason;
        long stuMobile, stuRollno;
        int stuYear;
        stuName = this.stuName.getText();
        if (stuMale.isSelected()) {
            stuGender = "Male";
        } else if (stuFemale.isSelected()) {
            stuGender = "Female";
        } else if (stuOther.isSelected()) {
            stuGender = "Other";
        }
        stuEmail = this.stuEmail.getText();
        stuBranch = this.stuBranch.getText();
        stuRollno = Long.parseLong(this.stuRollno.getText());
        stuMobile = Long.parseLong(this.stuMobile.getText());
        stuYear = Integer.parseInt((String) this.stuYear.getSelectedItem());
        stuDetail = this.stuDetail.getText();
        stuAddress = this.stuAddress.getText();
        stuSeason = this.stuSeason.getText();
        ...
        try {
            ...
            qry = "INSERT INTO db_Student(stu_name,stu_gender,stu_email,stu_rollno,stu_branch,stu_year,stu_mobile,stu_detail,stu_address,stu_season) VALUES('" + stuName + "', '" + stuGender + "', '" + stuEmail + "'," + stuRollno + ",'" + stuBranch + "'," + stuYear + ", " + stuMobile + ",'" + stuDetail + "' , '" + stuAddress + "', '" + stuSeason + "')";
            stmt = con.createStatement();
    ...
    private void updateBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_updateBtnActionPerformed
        ...
        stuRollno = Long.parseLong(this.stuRollno.getText());
        stuMobile = Long.parseLong(this.stuMobile.getText());
        stuYear = Integer.parseInt((String) this.stuYear.getSelectedItem().toString());
        stuDetail = this.stuDetail.getText();
        stuAddress = this.stuAddress.getText();
        stuSeason = this.stuSeason.getText();
        ...
        try {
            con = DriverManager.getConnection("jdbc:mysql://localhost:3306/db_Book_Record_System", "root", "");
            stmt = con.createStatement();
            qry = "UPDATE db_Student SET stu_name = '" + stuName + "', stu_gender='" + stuGender + "', stu_email='" + stuEmail + "',stu_branch='" + stuBranch + "',stu_year=" + stuYear + ",stu_rollno='" + stuRollno + "' ,stu_mobile=" + stuMobile + " , stu_detail='" + stuDetail + "', stu_address='" + stuAddress + "', stu_season='" + stuSeason + "' WHERE stu_id = " + Integer.parseInt(stuId.getText());
    ...
    private void deleteBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_deleteBtnActionPerformed
        ...
        try {
            ...
            if (delete == 0) {
                // 0:yes 1:No 2:cancel
                qry = "Delete From db_Student where stu_id=" + Integer.parseInt(stuId.getText());
                int row = stmt.executeUpdate(qry);
                if (row > 0) {
                    LoadStudentData();
                } else {
    ...
    private void StudentRecordsTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_StudentRecordsTableMouseClicked
        ...
        stuId.setText(tm.getValueAt(row, 1).toString());
        stuName.setText((String) tm.getValueAt(row, 2));
        if (tm.getValueAt(row, 3).toString().equalsIgnoreCase("male")) {
            ...
            stuOther.setSelected(true);
        }
        stuEmail.setText(tm.getValueAt(row, 4).toString());
        stuMobile.setText(tm.getValueAt(row, 5).toString());
        stuRollno.setText(tm.getValueAt(row, 6).toString());
        stuBranch.setText(tm.getValueAt(row, 7).toString());
        stuYear.setSelectedItem(tm.getValueAt(row, 8).toString());
        stuDetail.setText(tm.getValueAt(row, 9).toString());
        stuAddress.setText(tm.getValueAt(row, 10).toString());
        stuSeason.setText(tm.getValueAt(row, 11).toString());
    ...
    private javax.swing.JLabel bName7;
    private javax.swing.JLabel bName8;
    private javax.swing.JLabel bName9;
    ...
    private javax.swing.JTextField stuBranch;
    private javax.swing.ButtonGroup stuBtnGroup;
    private javax.swing.JTextField stuDetail;
    private javax.swing.JTextField stuEmail;
    private javax.swing.JCheckBox stuFemale;
    private javax.swing.JTextField stuId;
    private javax.swing.JCheckBox stuMale;
    private javax.swing.JTextField stuMobile;
    private javax.swing.JTextField stuName;
    private javax.swing.JCheckBox stuOther;
    private javax.swing.JTextField stuRollno;
    private javax.swing.JTextField stuSeason;
    private javax.swing.JComboBox<String> stuYear;
    public javax.swing.JTextField stu_txt_search;
